        ...
        <div class="max-w-3xl mx-auto px-6">
            ...
            <div class="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
                <div class="flex items-start justify-between gap-4">
                    <div>
                        <h3 class="text-lg font-semibold text-slate-900">Staff details</h3>
                        <p class="text-sm text-slate-600 mt-1">
                            Make sure email is unique and role is correct.
                        </p>
                    </div>
                ...
                <form method="POST" action="{{ route('admin.staff.store') }}" class="mt-6 space-y-5">
                    @csrf
